...
public class OrderDAOImpl implements OrderDAO {
    ...
    public boolean save(Order order) throws Exception {
        try {
            return CrudUtil.execute("INSERT INTO `Order` VALUES (?,?,?)", order.getId(), order.getDate(), order.getMotherId());
    ...
    public boolean update(Order order) throws Exception {
        return CrudUtil.execute("UPDATE Order SET date=?, customerId=? WHERE id=?", order.getDate(), order.getMotherId(), order.getId());
    }
